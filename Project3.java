...
public class Project3 {
   ...
   public static void main(String[] args) {
        ...
        while(mainSelect != 4) {
            ...
            if ((mainSelect == 2) || (mainSelect ==3)) {
               ...
               if ( (isDeposit(mainSelect) == true)) {
                   ...
                   validDeposit = deposit(transaction, currencyType);
               ...
               if ( (isDeposit(mainSelect) == false)) {
                   ...
                   validWithdraw = withdraw(transaction, currencyType);
                   //Prints success or failure message
                   System.out.println(logTransaction(amount, currencyType, isDeposit(mainSelect)));
               }
            }
    ...
    public static double convertCurrency( double amount, int currencyType, boolean isConvertToUSD) {
        ...
        //Returns changed int reflecting conversion selected by user
        return conversion;   
    }
    ...
    public static boolean deposit (double amount, int currencyType) {
        ...
        //Checks to see if balance will be valid after deposit, while ensuring that the user hasnt entered a negative input
        if ( (updateBalance(balance + amount) == true) && (amount > 0) ) {
            updateBalance(tempBalance + amount);
            return true;
        }
        else 
            balance = tempBalance;
    ...
    public static boolean withdraw (double amount, int currencyType) {
        ...
        //Bug #100000, Conceptual Change 1
        if(currencyType != 1) 
            amount *= 1.005;
